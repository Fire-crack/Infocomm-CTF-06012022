# You are on a ferry toward an island, but there was suddenly a storm that came in faster than anyone expected.
# 
# 
# The ferry needs to take evasive actions!
# Unfortunately, the ship's navigation computer seems to be malfunctioning
# Rather than giving a route directly to safety, it produced extremely circuitous instructions. (Oh no!)
...
# 
# The flag would be CTFInfocomm{distance}
